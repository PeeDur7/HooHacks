  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4"
      ...
      <div className="w-full max-w-sm rounded-3xl p-8"
        ...
        <h1 className="text-3xl mb-1" style={{ color: "#1e3a2a" }}>Create account</h1>
        <p className="mb-8 text-sm" style={{ fontFamily: "'DM Mono', monospace", color: "#4a7c59" }}>Start analyzing your meals</p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            <label className="text-xs uppercase tracking-widest" style={{ fontFamily: "'DM Mono', monospace", color: "#4a7c59" }}>Username</label>
            <input type="text" required value={username} onChange={(e) => setUsername(e.target.value)}
              placeholder="yourname" className="w-full px-4 py-3 rounded-xl outline-none text-sm"
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs uppercase tracking-widest" style={{ fontFamily: "'DM Mono', monospace", color: "#4a7c59" }}>Confirm Password</label>
        ...
        <p className="text-center text-xs mt-6" style={{ fontFamily: "'DM Mono', monospace", color: "#4a7c59" }}>
          ...
          <Link to="/login" style={{ color: "#2d5a3d", fontWeight: 500 }}>Log in</Link>
        </p>
      </div>
    </div>
  );
